...
%{_qt6_plugindir}/babelfishplugin.so
%{_qt6_plugindir}/dolphinpart/kpartplugins/kimgallery.so
%{_qt6_plugindir}/dolphinpart/kpartplugins/konq_shellcmdplugin.so
%{_qt6_plugindir}/dolphinpart/kpartplugins/dirfilterplugin.so
%{_qt6_plugindir}/khtml/kpartplugins/akregatorkonqfeediconkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/autorefreshkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/babelfishpluginkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/khtmlsettingspluginkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/khtmlttspluginkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/konqueror_kget_browser_integrationkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/uachangerpluginkhtml_kpartplugins.so
%{_qt6_plugindir}/khtml/kpartplugins/webarchiverpluginkhtml_kpartplugins.so
%{_qt6_plugindir}/khtmlsettingsplugin.so
%{_qt6_plugindir}/khtmlttsplugin.so
%{_qt6_plugindir}/konqueror/kpartplugins/searchbarplugin.so
%{_qt6_plugindir}/konqueror_kget_browser_integration.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/akregatorkonqfeediconkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/autorefreshkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/babelfishpluginkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/khtmlsettingspluginkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/khtmlttspluginkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/konqueror_kget_browser_integrationkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/uachangerpluginkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/kwebkitpart/kpartplugins/webarchiverpluginkwebkitpart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/akregatorkonqfeediconwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/autorefreshwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/babelfishpluginwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/khtmlsettingspluginwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/khtmlttspluginwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/konqueror_kget_browser_integrationwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/uachangerpluginwebenginepart_kpartplugins.so
%{_qt6_plugindir}/webenginepart/kpartplugins/webarchiverpluginwebenginepart_kpartplugins.so
%{_qt6_plugindir}/kf6/parts/fsviewpart.so
%{_qt6_plugindir}/kf6/parts/konq_sidebar.so
...
%{_qt6_plugindir}/konqsidebar_bookmarks.so
%{_qt6_plugindir}/konqsidebar_history.so
%{_qt6_plugindir}/konqsidebar_places.so
%{_qt6_plugindir}/konqsidebar_tree.so
%{_qt6_plugindir}/uachangerplugin.so
